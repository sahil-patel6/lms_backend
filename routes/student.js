...
/// UPDATE STUDENT ROUTE CAN EITHER BY USED BY ADMIN OR STUDENT HIMSELF
router.put("/student/:studentId/:adminId", isSignedIn, isAuthenticated, isAdmin,setStudentUploadDir,handleForm, updateStudent);
