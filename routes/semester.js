...
router.get(
  "/semester/:semesterId/teacher/:teacherId",
  isSignedIn,
  isAuthenticated,
  isTeacher,
  getSemester
...
router.get(
  "/semester/:semesterId/parent/:parentId",
  isSignedIn,
  isAuthenticated,
  isParent,
  getSemester
...
router.get(
  "/semesters/:departmentId/admin/:adminId",
  isSignedIn,
  isAuthenticated,
  isAdmin,
  checkIfDepartmentExists,
...
router.get(
  "/semesters/:departmentId/teacher/:teacherId",
  isSignedIn,
  isAuthenticated,
  isTeacher,
  checkIfDepartmentExists,
...
router.get(
  "/semesters/:departmentId/student/:studentId",
  isSignedIn,
  isAuthenticated,
  isStudent,
  checkIfDepartmentExists,
...
router.get(
  "/semesters/:departmentId/parent/:parentId",
  isSignedIn,
  isAuthenticated,
  isParent,
  checkIfDepartmentExists,
